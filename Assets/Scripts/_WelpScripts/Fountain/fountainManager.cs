...
public class fountainManager : MonoBehaviour
{
    ...
    [Header("Game Prefabs")]
    public List<GameObject> fountains = new List<GameObject>();
    ...
    IEnumerator igniteTheCandle(int index)
    {
        ...
        fountains[index].transform.GetChild(0).gameObject.SetActive(true);
        fountains[index].transform.GetChild(1).gameObject.SetActive(true);
    ...
    void setAllCandleAnimationToFalse()
    {
        ...
        {
            fountains[i].transform.GetChild(0).gameObject.SetActive(false);
            fountains[i].transform.GetChild(1).gameObject.SetActive(false);
        }
